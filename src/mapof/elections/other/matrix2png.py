...
def matrix2png(argv):
    ...
    if len(argv) < 4:
        print("Invocation:")
        print("  python3 matrix2png num_candidates pseudo_culture_id reorder [param1]")
        print(
            "  reorder -- election_id of the pseudo_culture_id to try to resemble (e.g., ID, or AN); use org to use original order")
        print("")
        exit()
